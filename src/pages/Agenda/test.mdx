...
| Lab Environment Overview              |               |    15 Minutes |
| Access Validation to Lab Environment  |               |    15 Minutes |
...
- Product Overview  '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'  15 Minutes
- Lab Environment Overview ~~~~~~~~~~~~~~~~~~~~~~~~  15 Minutes
- Access Validation to Lab Environment 
- Product Demo
- Lab #1  - Agent Installation Lab
- Lab #2  - Agent Troubleshooting Lab
- Lab #3  - Agent Configuration Lab
- Lunch Break
- Pricing and Deployment options
- Lab #4  - Robot Shop Lab
- Lab #5  - Dynamic Focus Query Lab
- Lab #6  - Application Perspectives Lab
- Lab #7  - Service Mapping Lab
- Lab #8  - Endpoint Mapping Lab
...
| ---------------- | :-----------: | -----: |
| col 3 is     2:47 PM 1/30/2023 | right-aligned | \$1600 |
