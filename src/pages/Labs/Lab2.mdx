...
export const Title = () => (
  <span>
    ARM 2 - Drilling into the RobotShop application <br />
  </span>
)
;
...
- If the Actions Panel displays "No Data", Turbo may need a few more minutes to populate fully. Try clicking on any part of the supply chain that isn't at full health (the circle is partially red). If the entire supply chain is fully green, validate all previous steps have been completed, call over an instructor if it continues to persist.

![Lab2](images/Robo_Action8.png)
