...
Navigate to the top left corner click on "Activities", and select "FireFox". Most necessary pages will be pre-populated.

![bastion1](img/addtargets/bastion1.png)

Add a new tab in the top right, and paste the lab link into the browser address bar: https://ibm.biz/Turbo1Day. This way, you can follow the lab instructions and copy/paste commands without having to switch to your desktop view.

![bastion0](img/labenv/bastion0.png)
...
![desktop3](img/labenv/desktop3.png)
