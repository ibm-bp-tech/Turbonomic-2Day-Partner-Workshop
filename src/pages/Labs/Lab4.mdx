...
3. This will open up the "Configure Volume Policy" page. 
    ...
    10- Scroll further down until you see a graph of Settings Impact and its settings below it. They are set to defaults in Turbonomic but if you wanted to change that this section is where you do it for the specified group of resources. The chart in this page will show the effect of changing each setting.
